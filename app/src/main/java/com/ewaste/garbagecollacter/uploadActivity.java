...
public class uploadActivity extends AppCompatActivity {
    ...
    FirebaseAuth mAuth;
    String uid;
    String[] arrClint = {"E-Waste","Bio Waste","Plastic Waste","Metals Waste","combine Waste"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        uploadWork = findViewById(R.id.uploadWeight);
        ...
        if(bundle != null){
            uploadAdd.setText(bundle.getString("add"));
        }
    ...
    public void saveData(){
        StorageReference storageReference = FirebaseStorage.getInstance().getReference().child("Garbage")
    ...
    public void uploadData(){
        ...
        String weight = uploadWork.getText().toString();
        String number= uploadNumber.getText().toString();
        String address= uploadAdd.getText().toString();
        String clint=value;

        DataClass dataClass = new DataClass(name,imageUrl,weight,address,number,clint);

        String cDate= DateFormat.getDateTimeInstance().format(Calendar.getInstance().getTime());

        FirebaseDatabase.getInstance().getReference("Garbage").child(uid).child(cDate)
